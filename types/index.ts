...
export const PERSONAS: Persona[] = [
  {
    ...
    suggestedQuestions: [
      'What market trends are influencing product roadmaps in the AV industry?',
      'What barriers are vendors facing in driving adoption of their solutions?',
      'How do you anticipate customer needs evolving in the next 12 months?',
      'How are channel relationships between vendors, distributors and resellers evolving?',
    ],
    systemPromptHint:
  ...
  },
  {
    ...
    suggestedQuestions: [
      'What trends are shaping inventory and distribution strategies in the AV channel?',
      'How are margin structures affecting the ability to support reseller partners?',
      'What challenges exist in ensuring product availability across the channel?',
      'What factors are influencing distributor choice of vendor partnerships?',
    ],
    systemPromptHint:
  ...
  },
  {
    ...
    suggestedQuestions: [
      "What trends are most impacting customers' buying decisions right now?",
      'What obstacles do resellers face when convincing customers to adopt new solutions?',
      'What pricing models are working best for AV resellers and their customers?',
      'What support do resellers need from vendors and distributors to succeed?',
    ],
    systemPromptHint:
  ...
  },
  {
    ...
    suggestedQuestions: [
      'What trends are influencing technology investment decisions for organisations?',
      'What internal challenges are slowing down technology adoption?',
      'How are pricing models influencing purchasing decisions for AV solutions?',
      'What AV features and innovations matter most to organisations right now?',
    ],
    systemPromptHint:
  ...
  },
  {
    ...
    suggestedQuestions: [
      'What emerging trends should clients in the AV space be preparing for?',
      'What common adoption challenges are seen across end user client bases?',
      'Which technologies are expected to deliver the greatest ROI for clients?',
      'How do channel dynamics influence solution recommendations to clients?',
    ],
    systemPromptHint:
  ...
  },
  {
    ...
    suggestedQuestions: [
      'What market trends are developing across AV products and technology?',
      'What common adoption challenges exist across all channel segments?',
      'What innovations are influencing channel strategies in the AV industry?',
      'How are channel dynamics influencing partnership decisions across the market?',
    ],
    systemPromptHint:
